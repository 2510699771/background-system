  ...
  <div>
    <el-menu router :default-active="$route.path" unique-opened>
      ...
      <template v-for="item in menus">
        <el-submenu :key="item.url" :index="item.id" v-if="item.children && item.children.length > 0">
          ...
          <el-menu-item-group>
            ...
            <el-menu-item :index="item1.url" v-for="item1 in item.children" :key="item1.url">
              <!-- slot="title"可加可不加 -->
        ...
        <el-menu-item :index="item.id" :key="item.url" v-else>
