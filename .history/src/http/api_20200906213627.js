...
export default {
    ...
    getOrders(
        ...
        return servic.get(`orders?query=${query}&pagenum=${pagenum}&pagesize=${pagesize}&user_id=${user_id}&pay_status=${pay_status}&is_send=$is_send=${is_send}&order_fapiao_title=${}`)
    }
}