      ...
      <el-dialog title="编辑用户" :visible.sync="editorUser" width="40vw">
        <el-form v-model="solouser" ref="editorForm" label-width="70px">
          <el-form-item label="用户名">
            <el-input v-model="solouser.username"></el-input>
          </el-form-item>
...
const userModule = createNamespacedHelpers("reports");
const { mapState: reportsState, mapActions: reportsActions } = userModule;
export default {
  name: "",
  //接受父组件传递的数据
  props: {},
