  ...
  <div>
    <el-card class="box-card">
      ...
      <el-dialog title="添加用户" :visible.sync="addbounced">
        ...
        <el-input placeholder="请输入密码" v-model="password" password clearable></el-input>
        <el-input placeholder="请输入邮箱" v-model="emall" clearable></el-input>
        <el-input placeholder="请输入电话" v-model="phone" clearable></el-input>
