  ...
  <div>
    <el-card class="box-card">
      ...
      <el-dialog title="编辑用户" :visible.sync="editorUser" width="40vw">
        <el-form :model="solouser" label-width="70px">
          <el-form-item label="用户名">
            <el-input v-model="solouser.username" autocomplete="off" :disabled="true"></el-input>
          </el-form-item>
          <el-form-item label="邮箱">
            <el-input v-model="solouser.email" autocomplete="off"></el-input>
          </el-form-item>
          <el-form-item label="电话">
            <el-input v-model="solouser.mobile" autocomplete="off"></el-input>
          </el-form-item>
        </el-form>
        <div slot="footer" class="dialog-footer">
...
export default {
  ...
  methods: {
    ...
    //方法展开
    ...userActions(["getUsers", "delUser", "addUser", "state", "queryUser"]),
