  ...
  <div>
    <el-card class="box-card">
      <div style="width:30vw;display:flex">
        ...
        <el-button type="primary" style="margin-left:20px" @click="oadd">添加用户</el-button>
      </div>
...
export default {
  ...
  methods: {
    ...
    add() {
      this.addUser({
        username: this.username, //添加用户姓名
        password: this.password, //添加用户密码
        email: this.email, //邮箱
