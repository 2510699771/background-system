  ...
  <el-card class="box-card">
    <div>
      ...
      <myfrom
        ...
        :table="table"
      >
        <template v-slot:state="s">
          <el-button type="primary" icon="el-icon-edit" size="mini" @click="editor"></el-button>
          <el-button type="danger" icon="el-icon-delete" size="mini" @click="delGood"></el-button>
        </template>
      </myfrom>
      <!-- 对话框组件(全) -->
      <mydialog
