    ...
    <div>
      ...
      >
        <template v-slot:state="scope">
          <el-button type="primary" icon="el-icon-edit" size="mini" @click="editor(scope.scope)"></el-button>
          <el-button type="danger" icon="el-icon-delete" size="mini" @click="delGood(scope.scope)"></el-button>
        </template>
      </myfrom>
      <!-- 对话框组件(全) -->
      <mydialog
