...
export default {
  ...
  mounted() {
    ...
    for (let i in area.city_list) {
      city.push(area.city_list[i]);
    }
    let county_list = [];
    for (let a in area.county_list) {
      county_list.push(area.county_list[a])
    }
    let province_list=[]
    for (let b in area.county_list) {
      province_list.push(area.county_list[b])
    }
