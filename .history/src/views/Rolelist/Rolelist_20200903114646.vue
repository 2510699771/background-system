...
export default {
  ...
  methods: {
    ...
    editor(e) {
      console.log(e.$index);
      // this.Dialogfrom.map((item, index) => {
      //   if (index === e.$index) {
      //     console.log(index, "index");
      //     item.value = e.row.roleName;
      //     console.log(e.row.roleName, "123");
      //   }
      // });
      this.Dialogfrom[0].value = e.row.roleName;
      console.log(this.Dialogfrom[0].value, "13");
       console.log(this.Dialogfrom, "Dialogfrom");
      this.Visible = true;
    },
    //对话框取消
    cancel() {
