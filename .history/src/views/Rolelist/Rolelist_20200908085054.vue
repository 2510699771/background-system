  ...
  <div>
    ...
    >
      ...
      <template v-slot:action="scope">
        ...
        <el-button type="warning" size="mini" @click="distribution(scope.scope)">分配权限</el-button>
      </template>
    </myfrom>
...
export default {
  ...
  methods: {
    //方法展开
    ...userActions(["getRoles", "SubmitRole", "adRole", "delRole","getRights"]),
    add(val) {
