    ...
    >
      ...
      <template v-slot:expand="scope">
        ...
        <div v-if="scope.scope.row.children">
          <el-tag v-for="(item,index) in scope.scope.row.children" :key="index">{{item.authName}}
            <div v-if="item.children">
               <el-tag v-for="(item,index) in scope.scope.row.children" :key="index">{{item.authName}}<el-tag></el-tag>
            </div>
          </el-tag>
        </div>
      </template>
