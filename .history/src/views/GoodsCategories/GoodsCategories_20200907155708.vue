  ...
  <div>
    ...
    >
      ...
      <template slot="likes" scope="scope">
        <el-button type="primary" icon="el-icon-edit" size="medium" @click="editor(scope)" style="width:">编辑</el-button>
        <el-button type="danger" icon="el-icon-delete" size="medium" @click="del(scope)">删除</el-button>
      </template>
    </tree-table>
  </div>
</template>
