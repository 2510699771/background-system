  ...
  <div>
    ...
    >
      ...
      <template v-slot:tree="scope">
        <el-button @click="into(scope)"></el-button>
        <!-- <v-jstree :data="scope.scope" show-checkbox multiple allow-batch whole-row @item-click="itemClick"></v-jstree> -->
      </template>
    </myfrom>
  </div>
</template>
...
export default {
  ...
  methods: {
    itemClick(){},
    into(scope) {
      console.log(scope.scope.row, "646546565");
    },
    //方法展开
