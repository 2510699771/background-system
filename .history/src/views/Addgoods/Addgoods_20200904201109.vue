          ...
          <div v-if="index===0">
            <el-form :model="from">
              <el-form-item
                ...
                style="width:80%"
              >
                <el-input v-model="item.value" style="margin-top:10px"></el-input>
              </el-form-item>
            </el-form>
          </div>
  ...
  data() {
    return {
      ...
      from: [
        ...
        { table: "商品价格", value: "", disabled: false },
        { table: "商品重量", value: "", disabled: false },
        { table: "商品数量", value: "", disabled: false },
      ],
      goods_name: "", //商品名称
