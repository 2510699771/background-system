        ...
        >
          <div v-if="index===0">
            <el-form :model="ruleForm" status-icon rules="rules" ref="ruleForm" label-width="100px">
              ...
              <el-form-item label="商品价格" rules="rules.goods_price" prop="goods_price">
                <el-input v-model="ruleForm.goods_price"></el-input>
              </el-form-item>
              <el-form-item label="商品重量" prop="goods_weight" rules="goods_weight">
                <el-input v-model="ruleForm.goods_weight"></el-input>
              </el-form-item>
              <el-form-item label="商品数量" prop="goods_number" rules="goods_number">
