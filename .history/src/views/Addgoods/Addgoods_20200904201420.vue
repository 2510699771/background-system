          ...
          <div v-if="index===0">
            <el-form :model="from">
              <el-form-item
                ...
                style="width:80%"
              >
                <el-input v-model="item.value" style="margin-top:10px" :disabled="item.disabled" @change="input(index)" ></el-input>
              </el-form-item>
            </el-form>
          </div>
...
export default {
  ...
  data() {
    return {
      ...
      from: [
        { table: "商品名称", value: "", disabled: false },
        { table: "商品价格", value: "", disabled: true },
        { table: "商品重量", value: "", disabled: true },
        { table: "商品数量", value: "", disabled: true },
      ],
      goods_name: "", //商品名称
