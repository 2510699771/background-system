          ...
          <div v-if="index===0">
            ...
            >
              ...
              <el-form-item label="商品价格" prop="goods_price">
                <el-input type="password" v-model="ruleForm.goods_price"></el-input>
              </el-form-item>
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        goods_name: [{ validator: validatePass, trigger: "blur" }],
        goods_price: [{ validator: validatePass2, trigger: "blur" }],
        goods_number: [{ validator: checkAge, trigger: "blur" }],
        goods_weight: [required: true, message: '域名不能为空', trigger: 'blur'],
      },
